...
/// Miner-side triedb prefetcher type (unified handle, same as fullnode path).
pub type MinerTrieDbPrefetcher = reth_engine_tree::tree::triedb_prefetcher::TrieDBPrefetchHandle;
