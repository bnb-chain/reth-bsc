use crate::{
    chainspec::BscChainSpec, consensus::parlia::{Parlia, SnapshotProvider, EMPTY_WITHDRAWALS_HASH, EMPTY_REQUESTS_HASH}, hardforks::BscHardforks, node::evm::config::{BscBlockExecutionCtx, BscBlockExecutorFactory}
};
    ...
    ChainSpec: EthChainSpec + BscHardforks + 'static,
{
        ...
        Result<crate::node::primitives::BscBlock, BlockExecutionError>
    {
        ...
        if BscHardforks::is_cancun_active_at_timestamp(self.chain_spec.as_ref(), block_number, timestamp) {
            ...
            if BscHardforks::is_prague_active_at_timestamp(self.chain_spec.as_ref(), block_number, timestamp) {
    ...
    ChainSpec: EthChainSpec + EthereumHardforks + crate::hardforks::BscHardforks + 'static,
{
    ...
    fn assemble_block(
        ...
        let requests_hash = BscHardforks::is_prague_active_at_timestamp(self.chain_spec.as_ref(), block_number, timestamp)
