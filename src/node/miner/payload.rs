    ...
    Pool: TransactionPool<Transaction: PoolTransaction<Consensus = TransactionSigned>> + 'static,
{
    ...
    pub async fn build_payload(
        ...
        // and inside `finish_with_difflayer` the write (after the sparse-trie wait) and the read-back
        ...
        // (flag off or triedb mode), this Mutex stays `None` and the builder falls through to
