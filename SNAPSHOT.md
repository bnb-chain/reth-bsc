...
| ---- | ---------| ------------------------|----------------------|
| ArchiveNode | BSC-MainNet | [reth_static_files_20251126.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/reth_static_files_20251126.tar.zst) | 1.828Ti |
| ArchiveNode | BSC-MainNet | [reth_db_20251126.tar.zst](https://pub-c5400abe5bed4adbaf8cd47467747e74.r2.dev/reth_db_20251126.tar.zst) | 2.286Ti |
...
2. **Extract the static files**:
   ```bash
   tar --use-compress-program=zstd -xf reth_static_files_20251126.tar.zst
   # This will create/populate the 'static_files' directory
   ```

3. **Extract the database files**:
   ```bash
   tar --use-compress-program=zstd -xf reth_db_20251126.tar.zst
